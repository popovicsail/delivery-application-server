    ...
    public partial class initialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1ddc68db-bb87-4cef-bdf8-d369bc1d5334"), 0, "3253fa89-f2f1-44f7-be8d-f1c1b53a7aa4", "admin@example3.com", true, "Glavni", "Admin", false, null, "ADMIN@EXAMPLE3.COM", "ADMIN3", "AQAAAAIAAYagAAAAEPCPeDsc6vvIMYZWW4qClVO0lWYuK5W1lodVc04aQvgBtvS4ma7/4GXV/l5pC6iIag==", null, true, null, null, false, "admin3" },
                    { new Guid("22222222-2222-2222-2222-222222222222"), 0, "c0b79fc0-fa31-428b-adb0-7d576c3c3013", "owner1@example.com", true, "Petar", "Petrović", false, null, "OWNER1@EXAMPLE.COM", "OWNER1", "AQAAAAIAAYagAAAAEFuLTW2pAsm1BHhXD4YNnhI922ZIKQ9pb+0Y/YTHF+Yb9bdrzQQm9qkyh+xdnTfcZQ==", null, false, null, "52e28d87-3e38-4d1f-b764-88db7b3a353d", false, "owner1" },
                    { new Guid("b22698b8-42a2-4115-9631-1c2d1e2ac5f7"), 0, "cda1c19d-f06c-4473-b442-0d292812fadf", "admin@example1.com", true, "Glavni", "Admin", false, null, "ADMIN@EXAMPLE1.COM", "ADMIN1", "AQAAAAIAAYagAAAAED//ojfejOnm0Ard7d5/bU0PJ+4RLjsBK2fgvFEtBrxxNCVsHekBpkbVjpO9GCE6Lg==", null, true, null, null, false, "admin1" },
                    { new Guid("bfd2ac09-67d0-4caa-8042-c6241b4f4f7f"), 0, "de77bd60-4264-40c7-8d86-a78f7062e4dc", "admin@example2.com", true, "Glavni", "Admin", false, null, "ADMIN@EXAMPLE2.COM", "ADMIN2", "AQAAAAIAAYagAAAAEMSU/UuNTkiqBIamghm/Uyeez+N2JZPveXyz5GVAp9ZYpjccfp/48e23Mc9FhlUbzA==", null, true, null, null, false, "admin2" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("265130ac-909d-4034-9427-e116a99886fa"), "Lactose", "Dairy" },
                    { new Guid("f90f0fa9-4f22-47a8-b0a3-f96c27ea2049"), "Gluten", "Cereals" }
                });
            ...
            migrationBuilder.InsertData(
                table: "restaurants",
                columns: new[] { "id", "address_id", "description", "name", "owner_id", "phone_number" },
                values: new object[] { new Guid("44444444-4444-4444-4444-444444444444"), new Guid("33333333-3333-3333-3333-333333333333"), "Autentična italijanska kuhinja sa peći na drva.", "Pizzeria Roma", new Guid("11111111-1111-1111-1111-111111111111"), "065/555-333-1" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("265130ac-909d-4034-9427-e116a99886fa"), new Guid("66666666-6666-6666-6666-666666666666") },
                    { new Guid("265130ac-909d-4034-9427-e116a99886fa"), new Guid("77777777-7777-7777-7777-777777777777") },
                    { new Guid("f90f0fa9-4f22-47a8-b0a3-f96c27ea2049"), new Guid("66666666-6666-6666-6666-666666666666") },
                    { new Guid("f90f0fa9-4f22-47a8-b0a3-f96c27ea2049"), new Guid("77777777-7777-7777-7777-777777777777") }
                });

            migrationBuilder.InsertData(
                table: "dish_option_groups",
                columns: new[] { "id", "dish_id", "name", "type" },
                values: new object[] { new Guid("71d059f4-ae5f-4f87-90c7-27a74a4aa7a3"), new Guid("77777777-7777-7777-7777-777777777777"), "Extra Toppings", "Zavisni" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("57f537e4-8c1b-4b38-b944-17ad0b6a73be"), new Guid("71d059f4-ae5f-4f87-90c7-27a74a4aa7a3"), "Ketchup", 50.0 },
                    { new Guid("730af5cd-9f06-4e67-9cd7-19ebfd3e8969"), new Guid("71d059f4-ae5f-4f87-90c7-27a74a4aa7a3"), "Extra Cheese", 120.0 }
                });
