    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0e77deee-0233-4123-a2fd-6046545f9f5d"), "Celer", "Povrće" },
                    { new Guid("1836c4a6-6722-45a2-9d0b-3a3a857184a0"), "Pšenica", "Žitarice" },
                    { new Guid("405bbd26-76ed-4908-ad39-e9fb2e28b3a0"), "Školjke", "Morski plodovi" },
                    { new Guid("7ec1c5f2-e932-4d2b-bd4a-22a03547ad6b"), "Gluten", "Žitarice" },
                    { new Guid("90ad0e3f-b995-457d-825e-73a1c449b308"), "Kikiriki", "Orašasti plodovi" },
                    { new Guid("e7806142-dfee-4a2a-8d96-8a79a31f3664"), "Jagode", "Voće" },
                    { new Guid("ea0e5245-9b46-48b7-9eb5-f6f02bb3b34b"), "Kivi", "Voće" },
                    { new Guid("f6e2a464-1b8b-4c6f-a755-94ab5c9d79ab"), "Banane", "Voće" },
                    { new Guid("fbc14f6e-a00c-42da-a236-40f50fdf3a6b"), "Paradajz", "Povrće" },
                    { new Guid("feecfa5e-2599-4839-98e2-d98ffae45416"), "Breskve", "Voće" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("46cd15b1-91ea-41a0-bbfa-5f98bc2c10d0"), new Guid("2d6ca452-a3ee-43d1-9c98-f35182e8e6e7"), "Autentična italijanska kuhinja.", "", "Pizzeria Roma", new Guid("33333333-3333-3333-3333-333333333333"), "222" });

            migrationBuilder.InsertData(
                table: "vouchers",
                columns: new[] { "id", "active", "code", "customer_id", "date_issued", "discount_amount", "expiration_date", "name" },
                values: new object[] { new Guid("32e9a835-8b0b-489c-80ba-ce197bafb254"), true, "2P2VT", new Guid("44444444-4444-4444-4444-444444444444"), new DateTime(2025, 10, 22, 16, 3, 56, 161, DateTimeKind.Utc).AddTicks(3078), 1200.0, new DateTime(2025, 10, 23, 16, 3, 56, 161, DateTimeKind.Utc).AddTicks(3057), "TestVaučer" });

            migrationBuilder.InsertData(
                table: "base_work_scheds",
                columns: new[] { "id", "restaurant_id", "saturday", "sunday", "weekend_end", "weekend_start", "work_day_end", "work_day_start" },
                values: new object[] { new Guid("c878a9b2-4f7c-467c-a3a8-03bae7f011ce"), new Guid("46cd15b1-91ea-41a0-bbfa-5f98bc2c10d0"), true, true, new TimeSpan(0, 21, 30, 0, 0), new TimeSpan(0, 12, 0, 0, 0), new TimeSpan(0, 22, 0, 0, 0), new TimeSpan(0, 10, 0, 0, 0) });

            migrationBuilder.InsertData(
                table: "menus",
                columns: new[] { "id", "name", "restaurant_id" },
                values: new object[] { new Guid("55555555-5555-5555-5555-555555555555"), "Pizza Menu", new Guid("46cd15b1-91ea-41a0-bbfa-5f98bc2c10d0") });

            migrationBuilder.InsertData(
                table: "dishes",
                columns: new[] { "id", "description", "menu_id", "name", "picture_url", "price", "type" },
                values: new object[] { new Guid("0ee25282-4d93-491f-a408-6017f7cfbfa0"), "Pica sa šunkom i sirom.", new Guid("55555555-5555-5555-5555-555555555555"), "Capricciosa", null, 750.0, "Pizza" });
