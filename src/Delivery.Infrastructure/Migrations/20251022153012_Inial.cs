    ...
    public partial class Inial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1b2aa135-4b95-4ecd-9cb7-42659f14a1ef"), "Kikiriki", "Orašasti plodovi" },
                    { new Guid("3092712d-5e81-4027-bf3a-73b69a307314"), "Celer", "Povrće" },
                    { new Guid("3b33305a-6ec7-4ada-a1dd-b7f90f1de940"), "Gluten", "Žitarice" },
                    { new Guid("473e8886-a4cf-40b6-bfde-34ff5b3330d8"), "Paradajz", "Povrće" },
                    { new Guid("9c306d7b-d583-435a-ae1d-47053ce75307"), "Kivi", "Voće" },
                    { new Guid("c363a229-e53f-4e55-972f-3549803fedb4"), "Banane", "Voće" },
                    { new Guid("d7e8ce38-ebf8-4538-879f-50d99f689cde"), "Pšenica", "Žitarice" },
                    { new Guid("e839be07-e631-493a-921a-dc7935ad0e53"), "Školjke", "Morski plodovi" },
                    { new Guid("efccfa03-50db-44c0-89eb-ab2a7e4c3f88"), "Jagode", "Voće" },
                    { new Guid("f3de1bc5-06f3-459c-8d85-3dc59239f5ef"), "Breskve", "Voće" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("3187eaa6-608b-4b1a-8c04-43adbc29ab6e"), new Guid("a516595d-9b09-4343-984e-aa1106242b4e"), "Autentična italijanska kuhinja.", "", "Pizzeria Roma", new Guid("33333333-3333-3333-3333-333333333333"), "222" });

            migrationBuilder.InsertData(
                table: "vouchers",
                columns: new[] { "id", "code", "customer_id", "date_issued", "discount_amount", "expiration_date", "name", "status" },
                values: new object[] { new Guid("c312e36f-017c-4215-89b0-fc88d0aef1ae"), "BGFRC", new Guid("44444444-4444-4444-4444-444444444444"), new DateTime(2025, 10, 22, 15, 30, 11, 997, DateTimeKind.Utc).AddTicks(930), 1200.0, new DateTime(2025, 10, 23, 15, 30, 11, 997, DateTimeKind.Utc).AddTicks(923), "TestVaučer", "Active" });

            migrationBuilder.InsertData(
                table: "base_work_scheds",
                columns: new[] { "id", "restaurant_id", "saturday", "sunday", "weekend_end", "weekend_start", "work_day_end", "work_day_start" },
                values: new object[] { new Guid("239abf91-d17b-43e1-83f5-b09f992391f1"), new Guid("3187eaa6-608b-4b1a-8c04-43adbc29ab6e"), true, true, new TimeSpan(0, 21, 30, 0, 0), new TimeSpan(0, 12, 0, 0, 0), new TimeSpan(0, 22, 0, 0, 0), new TimeSpan(0, 10, 0, 0, 0) });

            migrationBuilder.InsertData(
                table: "menus",
                columns: new[] { "id", "name", "restaurant_id" },
                values: new object[] { new Guid("85a1249b-7341-4a73-a0cf-69b9bcd6c816"), "Pizza Menu", new Guid("3187eaa6-608b-4b1a-8c04-43adbc29ab6e") });

            migrationBuilder.InsertData(
                table: "dishes",
                columns: new[] { "id", "description", "menu_id", "name", "picture_url", "price", "type" },
                values: new object[] { new Guid("868525c8-ada7-497a-a067-60fe84d62103"), "Pica sa šunkom i sirom.", new Guid("85a1249b-7341-4a73-a0cf-69b9bcd6c816"), "Capricciosa", null, 750.0, "Pizza" });
