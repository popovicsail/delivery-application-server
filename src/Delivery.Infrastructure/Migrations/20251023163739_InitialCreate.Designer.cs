...
namespace Delivery.Infrastructure.Migrations
{
    ...
    [Migration("20251023163739_InitialCreate")]
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.CommonEntities.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f139e6a9-c300-46a1-8bf1-51b235226fe5"),
                            City = "Beograd",
                            PostalCode = "11000",
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.CommonEntities.Allergen", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("95048277-ae7f-4218-9299-91ffbf6992bd"),
                            Name = "Kikiriki",
                            Type = "Orašasti plodovi"
                        },
                        new
                        {
                            Id = new Guid("49dd5f9f-3f42-40f8-9353-61f04e07314d"),
                            Name = "Jagode",
                            Type = "Voće"
                        },
                        new
                        {
                            Id = new Guid("093aca5a-d208-40b1-9bc0-20e0c77c4bed"),
                            Name = "Banane",
                            Type = "Voće"
                        },
                        new
                        {
                            Id = new Guid("9fd75e49-2d33-4490-9435-f7b35f8385bc"),
                            Name = "Kivi",
                            Type = "Voće"
                        },
                        new
                        {
                            Id = new Guid("6c755677-ad23-46b8-ba7a-9b16ba714115"),
                            Name = "Breskve",
                            Type = "Voće"
                        },
                        new
                        {
                            Id = new Guid("a6fb2bd5-2388-4ec5-88b2-4167b828f755"),
                            Name = "Paradajz",
                            Type = "Povrće"
                        },
                        new
                        {
                            Id = new Guid("48688d4e-7ec9-4ec3-8ad3-3bb44507e426"),
                            Name = "Celer",
                            Type = "Povrće"
                        },
                        new
                        {
                            Id = new Guid("574b3653-90af-4753-bf09-1120264089f4"),
                            Name = "Gluten",
                            Type = "Žitarice"
                        },
                        new
                        {
                            Id = new Guid("4c77ea02-25cc-407f-9116-5d2d6ae025bd"),
                            Name = "Pšenica",
                            Type = "Žitarice"
                        },
                        new
                        {
                            Id = new Guid("b482246f-edc5-49f8-97dd-bc86f7b61f5f"),
                            Name = "Školjke",
                            Type = "Morski plodovi"
                        });
                });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.CommonEntities.BaseWorkSched", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("afcbe434-520a-4a38-ae56-c4207e8767ee"),
                            RestaurantId = new Guid("e7f94b74-a77c-48a7-b9c6-d98857c78756"),
                            Saturday = true,
                            Sunday = true,
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.DishEntities.Dish", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f58a047e-792d-451a-8c42-85f39b2e8d0b"),
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.FeedbackEntities.FeedbackResponse", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Comment = "Jednostavno!",
                            CreatedAt = new DateTime(2025, 10, 23, 16, 37, 39, 168, DateTimeKind.Utc).AddTicks(6879),
                        ...
                        new
                        {
                            ...
                            Comment = "",
                            CreatedAt = new DateTime(2025, 10, 23, 16, 37, 39, 168, DateTimeKind.Utc).AddTicks(6882),
                        ...
                        new
                        {
                            ...
                            Comment = "",
                            CreatedAt = new DateTime(2025, 10, 23, 16, 37, 39, 168, DateTimeKind.Utc).AddTicks(6887),
                        ...
                        new
                        {
                            ...
                            Comment = "",
                            CreatedAt = new DateTime(2025, 10, 23, 16, 37, 39, 168, DateTimeKind.Utc).AddTicks(6889),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 23, 16, 37, 39, 168, DateTimeKind.Utc).AddTicks(6892),
                            QuestionId = new Guid("11111111-1111-1111-1111-111111111111"),
                            Rating = 2,
                        ...
                        new
                        {
                            ...
                            Comment = "Odlican!",
                            CreatedAt = new DateTime(2025, 10, 23, 16, 37, 39, 168, DateTimeKind.Utc).AddTicks(6894),
                            QuestionId = new Guid("22222222-2222-2222-2222-222222222222"),
                            Rating = 5,
                            UserId = new Guid("22222222-2222-2222-2222-222222222222")
                        },
                        new
                        {
                            ...
                            Comment = "Isporuka je bila na vreme.",
                            CreatedAt = new DateTime(2025, 10, 23, 16, 37, 39, 168, DateTimeKind.Utc).AddTicks(6905),
                            QuestionId = new Guid("33333333-3333-3333-3333-333333333333"),
                            Rating = 4,
                            UserId = new Guid("22222222-2222-2222-2222-222222222222")
                        },
                        new
                        {
                            ...
                            Comment = "",
                            CreatedAt = new DateTime(2025, 10, 23, 16, 37, 39, 168, DateTimeKind.Utc).AddTicks(6908),
                            QuestionId = new Guid("44444444-4444-4444-4444-444444444444"),
                            Rating = 2,
                            UserId = new Guid("22222222-2222-2222-2222-222222222222")
                        });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.RestaurantEntities.Restaurant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e7f94b74-a77c-48a7-b9c6-d98857c78756"),
                            AddressId = new Guid("f139e6a9-c300-46a1-8bf1-51b235226fe5"),
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.UserEntities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "da43ac05-295d-4179-b51c-7e7f04e422e6",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAENpxBoe1sjwLfL5SSZgUm8LwUj/ah1+FDWn1wld6dFUHAjc55P4tLE2bP5dpVFppEA==",
                            ...
                            SecurityStamp = "a2d62e43-7b16-496f-a6f1-4c21815b098f",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "10b2a0db-72b6-4d17-ae0e-e2d63492b3cd",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEDe613EXHnZ/c5JDapANOfp7cSBX/ColmWQTce/CSmg61KgbQ5Cc2XQgfN9MhgH5IQ==",
                            PhoneNumberConfirmed = false,
                            ProfilePictureUrl = "data:image/png;base64,",
                            SecurityStamp = "2908b3d9-b8db-4531-bc5d-74cd7aafba1c",
                            TwoFactorEnabled = false,
                            UserName = "admin2"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a6e082ec-6c7d-40a6-b219-c359cbc420f4",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEMrb/eLKa+bonA4AS6bV4mh0s8GGDhhiIXmgNWIGuSFRiuQmeQCFEH1NTSVj+nBPFA==",
                            PhoneNumberConfirmed = false,
                            ProfilePictureUrl = "data:image/png;base64,",
                            SecurityStamp = "81426219-646f-4e61-949b-98f54da0ffa0",
                            TwoFactorEnabled = false,
                            UserName = "admin3"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "914ef8b0-e93d-42f5-a14f-417d6c1efc3f",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEA1vrgTHovN+ab6MiL4kVJRXGvVHUz8Qd1egVRpL09EjNyU22R+61B6tjrpCh06dsA==",
                            PhoneNumberConfirmed = false,
                            ProfilePictureUrl = "data:image/png;base64,",
                            SecurityStamp = "013c8019-aaa5-44ba-9601-3ace38d153ca",
                            TwoFactorEnabled = false,
                            UserName = "owner1"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "19b13589-1d29-412c-812f-d02d91d3740c",
                            DateOfBirth = new DateTime(2025, 10, 23, 16, 37, 39, 128, DateTimeKind.Utc).AddTicks(6567),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEPbeREL6lAtzhIXlrRRs9wEH5zUXW2OAX6RlkGBB4EXhw9XhBIm7ocaxLe3WZfrDdQ==",
                            PhoneNumberConfirmed = false,
                            ProfilePictureUrl = "data:image/png;base64,",
                            SecurityStamp = "314d0d0f-5fb4-4023-a22e-21f63d635b5a",
                            TwoFactorEnabled = false,
                            UserName = "customer1"
                        });
                });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.UserEntities.Voucher", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("42b89f2e-e78c-40d4-a22b-88540edc2ef6"),
                            Active = true,
                            Code = "DSSSQ",
                            CustomerId = new Guid("44444444-4444-4444-4444-444444444444"),
                            DateIssued = new DateTime(2025, 10, 23, 16, 37, 39, 168, DateTimeKind.Utc).AddTicks(7526),
                            DiscountAmount = 1200.0,
                            ExpirationDate = new DateTime(2025, 10, 24, 16, 37, 39, 168, DateTimeKind.Utc).AddTicks(7518),
                            Name = "TestVaučer"
                        });
                });
