        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_voucher_customers_customer_id",
                        column: x => x.customer_id,
                        principalTable: "customers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1a14c5ac-f475-4f3d-85f6-edffc935d2e6"), "Jagode", "Voće" },
                    { new Guid("39d844fe-c5b2-4158-85b2-f539853dff61"), "Paradajz", "Povrće" },
                    { new Guid("47d2b6b7-7314-44b5-94d8-d60936ef19e8"), "Celer", "Povrće" },
                    { new Guid("4819d298-5768-4d22-be5d-83e8169cf0ed"), "Kikiriki", "Orašasti plodovi" },
                    { new Guid("73606f9c-2832-433a-a5a3-e13d143d1d02"), "Breskve", "Voće" },
                    { new Guid("79aaea40-960b-4bb3-8354-fa1d576e4b18"), "Pšenica", "Žitarice" },
                    { new Guid("815db3b8-1b29-486a-a320-22ce4ec35267"), "Školjke", "Morski plodovi" },
                    { new Guid("a43b1a33-d86a-49ae-8ef6-8d1bab037f6b"), "Banane", "Voće" },
                    { new Guid("c9742dad-8e43-4103-83b9-540afee93670"), "Kivi", "Voće" },
                    { new Guid("f7a60b06-5915-4180-9535-18d0e630f59f"), "Gluten", "Žitarice" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("5723690d-2abd-4726-86d8-a3a35d0de661"), new Guid("aee8d08c-eced-40ee-a33a-cb64e8326103"), new Guid("2d3fb90b-e7b0-466d-b75d-62188baeba73"), "Autentična italijanska kuhinja.", "", "Pizzeria Roma", new Guid("33333333-3333-3333-3333-333333333333"), "222" });

            migrationBuilder.InsertData(
                table: "voucher",
                columns: new[] { "id", "active", "customer_id", "date_issued", "discount_amount", "name" },
                values: new object[] { new Guid("46171458-8fe4-46c1-a96e-d460dea41c56"), false, new Guid("44444444-4444-4444-4444-444444444444"), new DateTime(2025, 10, 18, 22, 32, 10, 553, DateTimeKind.Utc).AddTicks(6757), 1200.0, "Rođendanski Vaučer" });

            migrationBuilder.InsertData(
                table: "base_work_scheds",
                columns: new[] { "id", "restaurant_id", "saturday", "sunday", "weekend_end", "weekend_start", "work_day_end", "work_day_start" },
                values: new object[] { new Guid("2d3fb90b-e7b0-466d-b75d-62188baeba73"), new Guid("5723690d-2abd-4726-86d8-a3a35d0de661"), true, true, new TimeSpan(0, 21, 30, 0, 0), new TimeSpan(0, 12, 0, 0, 0), new TimeSpan(0, 22, 0, 0, 0), new TimeSpan(0, 10, 0, 0, 0) });

            migrationBuilder.InsertData(
                table: "menus",
                columns: new[] { "id", "name", "restaurant_id" },
                values: new object[] { new Guid("6413cbf8-5268-44af-8712-4824b0552d12"), "Pizza Menu", new Guid("5723690d-2abd-4726-86d8-a3a35d0de661") });

            migrationBuilder.InsertData(
                table: "dishes",
                columns: new[] { "id", "description", "menu_id", "name", "picture_url", "price", "type" },
                values: new object[] { new Guid("02e1f759-93e4-4cb2-9f3b-eb39e105b4dd"), "Pica sa šunkom i sirom.", new Guid("6413cbf8-5268-44af-8712-4824b0552d12"), "Capricciosa", null, 750.0, "Pizza" });
