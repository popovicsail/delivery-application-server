            ...
            modelBuilder.Entity("Delivery.Domain.Entities.CommonEntities.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("69f42639-ff6b-4fc5-a186-84ea4d825611"),
                            City = "Beograd",
                            PostalCode = "11000",
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.CommonEntities.Allergen", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("48969850-1f20-4c8b-bd50-39c6c7ddaacb"),
                            Name = "Kikiriki",
                            Type = "Orašasti plodovi"
                        },
                        new
                        {
                            Id = new Guid("8189b6e7-9228-4120-b7eb-059b42237596"),
                            Name = "Jagode",
                            Type = "Voće"
                        },
                        new
                        {
                            Id = new Guid("d49af16a-4f67-4e41-be03-90bfa8b4986b"),
                            Name = "Banane",
                            Type = "Voće"
                        },
                        new
                        {
                            Id = new Guid("05c655e7-b522-4e71-84ab-62473cd9a52d"),
                            Name = "Kivi",
                            Type = "Voće"
                        },
                        new
                        {
                            Id = new Guid("4a03fee6-6d23-4706-b84c-fb3855f2bef4"),
                            Name = "Breskve",
                            Type = "Voće"
                        },
                        new
                        {
                            Id = new Guid("534e28f0-0104-446a-a022-cb6d9ed81893"),
                            Name = "Paradajz",
                            Type = "Povrće"
                        },
                        new
                        {
                            Id = new Guid("356c3b5c-3538-4b30-ab2b-d4c3feee5487"),
                            Name = "Celer",
                            Type = "Povrće"
                        },
                        new
                        {
                            Id = new Guid("84877b7b-1749-49e7-8e0c-de82ec91aaa2"),
                            Name = "Gluten",
                            Type = "Žitarice"
                        },
                        new
                        {
                            Id = new Guid("aedd214c-45ec-4981-803d-638b63f6f5ae"),
                            Name = "Pšenica",
                            Type = "Žitarice"
                        },
                        new
                        {
                            Id = new Guid("d1bdc8b3-70c9-4503-898d-29c8ec857c84"),
                            Name = "Školjke",
                            Type = "Morski plodovi"
                        });
                });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.CommonEntities.BaseWorkSched", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1e3dda6a-4ee7-4bd4-9fe5-26ba49490979"),
                            RestaurantId = new Guid("91e789ee-697d-4527-bc63-5eecc48eef27"),
                            Saturday = true,
                            Sunday = true,
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.DishEntities.Dish", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8418be06-9ac5-4b7a-99ff-c7746b9ff125"),
                            Description = "Pica sa šunkom i sirom.",
                            MenuId = new Guid("b7602d67-c863-4850-8a6e-08f629058404"),
                            Name = "Capricciosa",
                            Price = 750.0,
                            Type = "Pizza"
                        });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.FeedbackEntities.FeedbackResponse", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Comment = "Jednostavno!",
                            CreatedAt = new DateTime(2025, 10, 31, 14, 58, 15, 162, DateTimeKind.Utc).AddTicks(2613),
                        ...
                        new
                        {
                            ...
                            Comment = "",
                            CreatedAt = new DateTime(2025, 10, 31, 14, 58, 15, 162, DateTimeKind.Utc).AddTicks(2616),
                        ...
                        new
                        {
                            ...
                            Comment = "",
                            CreatedAt = new DateTime(2025, 10, 31, 14, 58, 15, 162, DateTimeKind.Utc).AddTicks(2619),
                        ...
                        new
                        {
                            ...
                            Comment = "",
                            CreatedAt = new DateTime(2025, 10, 31, 14, 58, 15, 162, DateTimeKind.Utc).AddTicks(2622),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 31, 14, 58, 15, 162, DateTimeKind.Utc).AddTicks(2626),
                            QuestionId = new Guid("11111111-1111-1111-1111-111111111111"),
                            Rating = 2,
                        ...
                        new
                        {
                            ...
                            Comment = "Odlican!",
                            CreatedAt = new DateTime(2025, 10, 31, 14, 58, 15, 162, DateTimeKind.Utc).AddTicks(2629),
                            QuestionId = new Guid("22222222-2222-2222-2222-222222222222"),
                            Rating = 5,
                            UserId = new Guid("22222222-2222-2222-2222-222222222222")
                        },
                        new
                        {
                            ...
                            Comment = "Isporuka je bila na vreme.",
                            CreatedAt = new DateTime(2025, 10, 31, 14, 58, 15, 162, DateTimeKind.Utc).AddTicks(2638),
                            QuestionId = new Guid("33333333-3333-3333-3333-333333333333"),
                            Rating = 4,
                            UserId = new Guid("22222222-2222-2222-2222-222222222222")
                        },
                        new
                        {
                            ...
                            Comment = "",
                            CreatedAt = new DateTime(2025, 10, 31, 14, 58, 15, 162, DateTimeKind.Utc).AddTicks(2641),
                            QuestionId = new Guid("44444444-4444-4444-4444-444444444444"),
                            Rating = 2,
                            UserId = new Guid("22222222-2222-2222-2222-222222222222")
                        });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.RestaurantEntities.Menu", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b7602d67-c863-4850-8a6e-08f629058404"),
                            Name = "Pizza Menu",
                            RestaurantId = new Guid("91e789ee-697d-4527-bc63-5eecc48eef27")
                        });
                });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.RestaurantEntities.Restaurant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("91e789ee-697d-4527-bc63-5eecc48eef27"),
                            AddressId = new Guid("69f42639-ff6b-4fc5-a186-84ea4d825611"),
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.UserEntities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "d0354567-999e-42f6-bb88-5007f82a12fb",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAECwKKIJ2NBDNCCX6a0I+omwd1wDIUPQqTRIZzEh3O6Yt60acjfFrQVD3JBbQ1wb5UA==",
                            ...
                            SecurityStamp = "17c0776c-d10d-4bf2-aea9-db20a6cc31f0",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "0419804c-384f-4cef-b665-f62031bcc718",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAELY3knO1ARkG5zm4fZeRc/QVUR4Ci/L9oX+7U1vW/S2ZybiAjTwN78kIeUg2bwxMkQ==",
                            PhoneNumberConfirmed = false,
                            ProfilePictureBase64 = "data:image/png;base64,",
                            SecurityStamp = "713939ee-9360-4b7e-921e-458aee40061d",
                            TwoFactorEnabled = false,
                            UserName = "admin2"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "2fa94533-2813-45c5-a6bb-7f1123714f3c",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEEyySRLqiQL1xVT4FaTd8HdvyVuh+o3wUWqneyGsV4CasDDWjKyroKeIhNos/4BWbw==",
                            PhoneNumberConfirmed = false,
                            ProfilePictureBase64 = "data:image/png;base64,",
                            SecurityStamp = "e00019e2-c5ff-4d93-ab02-e0f3e485fb71",
                            TwoFactorEnabled = false,
                            UserName = "admin3"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "8742bb00-7a17-4da4-9a07-0635d56b62dd",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEEq5pbWwUCBREOc2OlfI+Ig7mUQkzI21nqb5Im5k9Hv2r4yMKPB6B3FoRV5ZG+ocqQ==",
                            PhoneNumberConfirmed = false,
                            ProfilePictureBase64 = "data:image/png;base64,",
                            SecurityStamp = "ccc02081-9f79-4d54-b91d-f70a7f5b6938",
                            TwoFactorEnabled = false,
                            UserName = "owner1"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "8057cfcc-2ba2-4a29-bd35-a934ef0d2f04",
                            DateOfBirth = new DateTime(2025, 10, 31, 14, 58, 15, 120, DateTimeKind.Utc).AddTicks(8829),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEBRnOveyuEm+5Vs3KZZfuVpbOP0Kzb8ZcYINwFSvFg9Ny/iUkPMA5RGO5f5gAWNqOg==",
                            PhoneNumberConfirmed = false,
                            ProfilePictureBase64 = "data:image/png;base64,",
                            SecurityStamp = "eb3d03e6-4b23-4f0b-a35b-175a1d93c02f",
                            TwoFactorEnabled = false,
                            UserName = "customer1"
                        });
                });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.UserEntities.Voucher", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e9216ae8-bc66-46a8-8e81-5d673105cd94"),
                            Code = "TEF4Y",
                            CustomerId = new Guid("44444444-4444-4444-4444-444444444444"),
                            DateIssued = new DateTime(2025, 10, 31, 14, 58, 15, 162, DateTimeKind.Utc).AddTicks(2997),
                            DiscountAmount = 1200.0,
                            ExpirationDate = new DateTime(2025, 11, 1, 14, 58, 15, 162, DateTimeKind.Utc).AddTicks(2986),
                            Name = "TestVaučer",
                            Status = "Active"
                        });
                });
