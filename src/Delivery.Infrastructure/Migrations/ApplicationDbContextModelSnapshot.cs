            ...
            modelBuilder.Entity("Delivery.Domain.Entities.CommonEntities.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a9fe315a-705e-4397-89df-197f1cb5a30e"),
                            City = "Beograd",
                            PostalCode = "11000",
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.CommonEntities.Allergen", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9db56011-7c3c-4085-a05d-a2ead292e531"),
                            Name = "Kikiriki",
                            Type = "Orašasti plodovi"
                        },
                        new
                        {
                            Id = new Guid("998811bc-4e41-4601-8f9c-f7b74c673909"),
                            Name = "Jagode",
                            Type = "Voće"
                        },
                        new
                        {
                            Id = new Guid("338e907f-fd7d-4b08-b49d-2a1c191d0b27"),
                            Name = "Banane",
                            Type = "Voće"
                        },
                        new
                        {
                            Id = new Guid("d35482e3-c1f8-49d3-904d-410d9e2660fa"),
                            Name = "Kivi",
                            Type = "Voće"
                        },
                        new
                        {
                            Id = new Guid("ac44d9b9-701a-4d3b-9c25-0d977f9f6da5"),
                            Name = "Breskve",
                            Type = "Voće"
                        },
                        new
                        {
                            Id = new Guid("a7092a76-ede7-49cf-b7a3-889f04622d08"),
                            Name = "Paradajz",
                            Type = "Povrće"
                        },
                        new
                        {
                            Id = new Guid("931e3734-1743-4435-9b96-0c3f5ab4d672"),
                            Name = "Celer",
                            Type = "Povrće"
                        },
                        new
                        {
                            Id = new Guid("e42c7422-874b-47c5-82d6-abd7dfc41c40"),
                            Name = "Gluten",
                            Type = "Žitarice"
                        },
                        new
                        {
                            Id = new Guid("94e43383-c30a-4201-ac05-38223f8f377a"),
                            Name = "Pšenica",
                            Type = "Žitarice"
                        },
                        new
                        {
                            Id = new Guid("8c80ea7b-da3c-4b5e-83f1-3b3469170f1e"),
                            Name = "Školjke",
                            Type = "Morski plodovi"
                        });
                });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.CommonEntities.BaseWorkSched", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ee913063-3708-4487-a8e7-26772e8d170a"),
                            RestaurantId = new Guid("37fe6c14-b1a3-4758-ba3f-bfebb80581fc"),
                            Saturday = true,
                            Sunday = true,
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.DishEntities.Dish", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("724bcf5e-93bf-4da3-999a-68cedab854b5"),
                            Description = "Pica sa šunkom i sirom.",
                            MenuId = new Guid("09c97c9c-94c6-4ca0-8e90-a0c44ccb6ea4"),
                            Name = "Capricciosa",
                            Price = 750.0,
                            Type = "Pizza"
                        });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.FeedbackEntities.FeedbackResponse", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Comment = "Jednostavno!",
                            CreatedAt = new DateTime(2025, 11, 4, 15, 19, 45, 9, DateTimeKind.Utc).AddTicks(1585),
                        ...
                        new
                        {
                            ...
                            Comment = "",
                            CreatedAt = new DateTime(2025, 11, 4, 15, 19, 45, 9, DateTimeKind.Utc).AddTicks(1589),
                        ...
                        new
                        {
                            ...
                            Comment = "",
                            CreatedAt = new DateTime(2025, 11, 4, 15, 19, 45, 9, DateTimeKind.Utc).AddTicks(1593),
                        ...
                        new
                        {
                            ...
                            Comment = "",
                            CreatedAt = new DateTime(2025, 11, 4, 15, 19, 45, 9, DateTimeKind.Utc).AddTicks(1600),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 4, 15, 19, 45, 9, DateTimeKind.Utc).AddTicks(1604),
                            QuestionId = new Guid("11111111-1111-1111-1111-111111111111"),
                            Rating = 2,
                        ...
                        new
                        {
                            ...
                            Comment = "Odlican!",
                            CreatedAt = new DateTime(2025, 11, 4, 15, 19, 45, 9, DateTimeKind.Utc).AddTicks(1608),
                            QuestionId = new Guid("22222222-2222-2222-2222-222222222222"),
                            Rating = 5,
                            UserId = new Guid("22222222-2222-2222-2222-222222222222")
                        },
                        new
                        {
                            ...
                            Comment = "Isporuka je bila na vreme.",
                            CreatedAt = new DateTime(2025, 11, 4, 15, 19, 45, 9, DateTimeKind.Utc).AddTicks(1621),
                            QuestionId = new Guid("33333333-3333-3333-3333-333333333333"),
                            Rating = 4,
                            UserId = new Guid("22222222-2222-2222-2222-222222222222")
                        },
                        new
                        {
                            ...
                            Comment = "",
                            CreatedAt = new DateTime(2025, 11, 4, 15, 19, 45, 9, DateTimeKind.Utc).AddTicks(1625),
                            QuestionId = new Guid("44444444-4444-4444-4444-444444444444"),
                            Rating = 2,
                            UserId = new Guid("22222222-2222-2222-2222-222222222222")
                        });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.RestaurantEntities.Menu", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("09c97c9c-94c6-4ca0-8e90-a0c44ccb6ea4"),
                            Name = "Pizza Menu",
                            RestaurantId = new Guid("37fe6c14-b1a3-4758-ba3f-bfebb80581fc")
                        });
                });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.RestaurantEntities.Restaurant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("37fe6c14-b1a3-4758-ba3f-bfebb80581fc"),
                            AddressId = new Guid("a9fe315a-705e-4397-89df-197f1cb5a30e"),
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.UserEntities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "f1a66e3b-6e0e-4708-a948-e7cf01d34bfb",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEMVRoYtSbhXI4gTT1TXKC5e0dyT9whFfb/3Ih2OPubPeNpttZ0v4LLCz4oKfo4Zuyw==",
                            ...
                            SecurityStamp = "701d225b-f77d-448c-8ac1-e6a25dcd963b",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "8907230a-3276-4639-bd07-82cfcb41a924",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEJBcfNxq9QdtdYLkziFelqhRMvp5CZZ3RRiaFC68hRJYl9OO3NCq5u8C9POns26/Eg==",
                            PhoneNumberConfirmed = false,
                            ProfilePictureBase64 = "data:image/png;base64,",
                            SecurityStamp = "727ca81a-1d27-4317-8feb-14bf889a4de0",
                            TwoFactorEnabled = false,
                            UserName = "admin2"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "71665cc4-ac8b-4ba8-afc9-f4d10728d071",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEOL58CWxAOk99WOcojN7NV8egf5e1zUWU8R4/QGPQJ9dljFxoeZm+qfN4UtjPgzdWA==",
                            PhoneNumberConfirmed = false,
                            ProfilePictureBase64 = "data:image/png;base64,",
                            SecurityStamp = "71d96af5-5d2b-48a4-9561-d0edac7dee07",
                            TwoFactorEnabled = false,
                            UserName = "admin3"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b5163bac-680f-431b-aaf2-452caaf30a22",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEDd0a9RRAQGp5iAAGLAxN54tHu7DVHCZHsbs+Ln4/Mf1aIYAotkE+AljId44ANMksA==",
                            PhoneNumberConfirmed = false,
                            ProfilePictureBase64 = "data:image/png;base64,",
                            SecurityStamp = "66da21db-b192-4b8f-922c-3d2d0c323d5c",
                            TwoFactorEnabled = false,
                            UserName = "owner1"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3bb646ab-6088-447e-9ac5-4157f4b5f924",
                            DateOfBirth = new DateTime(2025, 11, 4, 15, 19, 44, 940, DateTimeKind.Utc).AddTicks(3939),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEIay+gMUOAzOg0KQm1ULn/ovfip8JJmKYXiheW9e1pN+9uLpF27ksRPl02YyWTQnLw==",
                            PhoneNumberConfirmed = false,
                            ProfilePictureBase64 = "data:image/png;base64,",
                            SecurityStamp = "081a441c-9824-4b89-81c6-592460d9e3ee",
                            TwoFactorEnabled = false,
                            UserName = "customer1"
                        });
                });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.UserEntities.Voucher", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1e945d86-e8d5-41c2-adae-aceeb7481d3e"),
                            Code = "ALIPB",
                            CustomerId = new Guid("44444444-4444-4444-4444-444444444444"),
                            DateIssued = new DateTime(2025, 11, 4, 15, 19, 45, 9, DateTimeKind.Utc).AddTicks(2240),
                            DiscountAmount = 1200.0,
                            ExpirationDate = new DateTime(2025, 11, 5, 15, 19, 45, 9, DateTimeKind.Utc).AddTicks(2229),
                            Name = "TestVaučer",
                            Status = "Active"
                        });
                });
