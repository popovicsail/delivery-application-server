            ...
            modelBuilder.Entity("Delivery.Domain.Entities.CommonEntities.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("128ecd05-f795-4289-9cda-8c02aa246940"),
                            City = "Beograd",
                            PostalCode = "11000",
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.CommonEntities.Allergen", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fa3ff7c9-9951-46a0-b0b4-04d902e70dc3"),
                            Name = "Kikiriki",
                            Type = "Orašasti plodovi"
                        },
                        new
                        {
                            Id = new Guid("e978a83e-fe22-4969-aea4-e54b97ed1e6e"),
                            Name = "Jagode",
                            Type = "Voće"
                        },
                        new
                        {
                            Id = new Guid("07784a81-59f1-44c6-a576-68112e1f085a"),
                            Name = "Banane",
                            Type = "Voće"
                        },
                        new
                        {
                            Id = new Guid("b860dd01-8942-456a-a002-2d6d2d46d12c"),
                            Name = "Kivi",
                            Type = "Voće"
                        },
                        new
                        {
                            Id = new Guid("a7e063c0-8ad7-401f-94d4-0721c00bc196"),
                            Name = "Breskve",
                            Type = "Voće"
                        },
                        new
                        {
                            Id = new Guid("8ef43edb-e607-42cb-b178-3d9e174d73ec"),
                            Name = "Paradajz",
                            Type = "Povrće"
                        },
                        new
                        {
                            Id = new Guid("df100d62-720b-4826-aded-d4bc5124655a"),
                            Name = "Celer",
                            Type = "Povrće"
                        },
                        new
                        {
                            Id = new Guid("10d0d3ac-09fa-42bd-be9f-b52dbd33a5b6"),
                            Name = "Gluten",
                            Type = "Žitarice"
                        },
                        new
                        {
                            Id = new Guid("860ea540-0ce8-4dfa-a463-944e3365a4e7"),
                            Name = "Pšenica",
                            Type = "Žitarice"
                        },
                        new
                        {
                            Id = new Guid("d4537ea3-05f9-4858-b05b-3e833e9b1065"),
                            Name = "Školjke",
                            Type = "Morski plodovi"
                        });
                });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.CommonEntities.BaseWorkSched", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9aa20a1b-9755-4483-a4d2-edbc9b8a0d96"),
                            RestaurantId = new Guid("2ae22bee-ddc1-4c6d-a0db-9f7e81bd2a36"),
                            Saturday = true,
                            Sunday = true,
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.DishEntities.Dish", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f75d6839-6ad8-4b2f-a366-a3ae56c33834"),
                            Description = "Pica sa šunkom i sirom.",
                            MenuId = new Guid("2e5e343b-07dc-4db9-839f-671654dbdcbf"),
                            Name = "Capricciosa",
                            Price = 750.0,
                            Type = "Pizza"
                        });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.FeedbackEntities.FeedbackResponse", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Comment = "Jednostavno!",
                            CreatedAt = new DateTime(2025, 10, 24, 15, 32, 12, 456, DateTimeKind.Utc).AddTicks(3212),
                        ...
                        new
                        {
                            ...
                            Comment = "",
                            CreatedAt = new DateTime(2025, 10, 24, 15, 32, 12, 456, DateTimeKind.Utc).AddTicks(3220),
                        ...
                        new
                        {
                            ...
                            Comment = "",
                            CreatedAt = new DateTime(2025, 10, 24, 15, 32, 12, 456, DateTimeKind.Utc).AddTicks(3223),
                        ...
                        new
                        {
                            ...
                            Comment = "",
                            CreatedAt = new DateTime(2025, 10, 24, 15, 32, 12, 456, DateTimeKind.Utc).AddTicks(3227),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 24, 15, 32, 12, 456, DateTimeKind.Utc).AddTicks(3230),
                            QuestionId = new Guid("11111111-1111-1111-1111-111111111111"),
                            Rating = 2,
                        ...
                        new
                        {
                            ...
                            Comment = "Odlican!",
                            CreatedAt = new DateTime(2025, 10, 24, 15, 32, 12, 456, DateTimeKind.Utc).AddTicks(3235),
                            QuestionId = new Guid("22222222-2222-2222-2222-222222222222"),
                            Rating = 5,
                            UserId = new Guid("22222222-2222-2222-2222-222222222222")
                        },
                        new
                        {
                            ...
                            Comment = "Isporuka je bila na vreme.",
                            CreatedAt = new DateTime(2025, 10, 24, 15, 32, 12, 456, DateTimeKind.Utc).AddTicks(3258),
                            QuestionId = new Guid("33333333-3333-3333-3333-333333333333"),
                            Rating = 4,
                            UserId = new Guid("22222222-2222-2222-2222-222222222222")
                        },
                        new
                        {
                            ...
                            Comment = "",
                            CreatedAt = new DateTime(2025, 10, 24, 15, 32, 12, 456, DateTimeKind.Utc).AddTicks(3262),
                            QuestionId = new Guid("44444444-4444-4444-4444-444444444444"),
                            Rating = 2,
                            UserId = new Guid("22222222-2222-2222-2222-222222222222")
                        });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.RestaurantEntities.Menu", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2e5e343b-07dc-4db9-839f-671654dbdcbf"),
                            Name = "Pizza Menu",
                            RestaurantId = new Guid("2ae22bee-ddc1-4c6d-a0db-9f7e81bd2a36")
                        });
                });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.RestaurantEntities.Restaurant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2ae22bee-ddc1-4c6d-a0db-9f7e81bd2a36"),
                            AddressId = new Guid("128ecd05-f795-4289-9cda-8c02aa246940"),
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.UserEntities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "adfa9aa7-02d6-4087-a67f-86451c122808",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAELlbii01RFCsyG/xFMeeNO/AcAvgXQTDLnPlS1AW30FtOOzJNPSBG1uiXumIS6F8xg==",
                            ...
                            SecurityStamp = "c8d33705-cdfc-47c9-8649-b93da1c76048",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "04673e04-7663-4a33-854c-8eb987f9978c",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEKxQNBTNNBLwRtDKJgtGN2FO7hlgumygyLYD1ZFOQdgaKMd/wpmAwGQ60RzfuODCSw==",
                            PhoneNumberConfirmed = false,
                            ProfilePictureBase64 = "data:image/png;base64,",
                            SecurityStamp = "f5f05c8a-3bd9-4ea6-a50a-d820f7b49cf5",
                            TwoFactorEnabled = false,
                            UserName = "admin2"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "7349361f-e9a7-499e-82c1-d5f74be344a0",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAECGMHdzYarF/gRbnugv+GqrfZ6M4t3wLXOZKxI8KYARxg5seRMeibGLarKarZTOJ3g==",
                            PhoneNumberConfirmed = false,
                            ProfilePictureBase64 = "data:image/png;base64,",
                            SecurityStamp = "592d24ee-7b5a-4094-b3d0-eb083224c17d",
                            TwoFactorEnabled = false,
                            UserName = "admin3"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "908d6e7e-db30-4604-a88c-305279c9bd2d",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEPi+hSf3WXAMyEypbcwmSYM6sa6oh1NNle2iEkuFf7xuJ7ZSNkym/n40JNtIAk9Ufw==",
                            PhoneNumberConfirmed = false,
                            ProfilePictureBase64 = "data:image/png;base64,",
                            SecurityStamp = "f4b67fae-b502-4975-b4a8-f11bd889a4f5",
                            TwoFactorEnabled = false,
                            UserName = "owner1"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "c87624e6-9d0c-4f3c-bbb9-1c8a371b3f5d",
                            DateOfBirth = new DateTime(2025, 10, 24, 15, 32, 12, 388, DateTimeKind.Utc).AddTicks(8654),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEMUzLTyIiq6kIbZ0snxHhrfgPXORjm+Rrul4B1+O7z4L0QkHeqbLnj9mLkkHc4PtJA==",
                            PhoneNumberConfirmed = false,
                            ProfilePictureBase64 = "data:image/png;base64,",
                            SecurityStamp = "150e00ed-027e-4d9c-bde6-b3296e8af62b",
                            TwoFactorEnabled = false,
                            UserName = "customer1"
                        });
                });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.UserEntities.Voucher", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fbf387fc-6471-4c96-8542-d3ba2a57621a"),
                            Code = "XYVBB",
                            CustomerId = new Guid("44444444-4444-4444-4444-444444444444"),
                            DateIssued = new DateTime(2025, 10, 24, 15, 32, 12, 456, DateTimeKind.Utc).AddTicks(3858),
                            DiscountAmount = 1200.0,
                            ExpirationDate = new DateTime(2025, 10, 25, 15, 32, 12, 456, DateTimeKind.Utc).AddTicks(3848),
                            Name = "TestVaučer",
                            Status = "Active"
                        });
                });
