            ...
            modelBuilder.Entity("Delivery.Domain.Entities.CommonEntities.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3c0796ab-118e-4e54-bb4b-09828a580b30"),
                            City = "Beograd",
                            PostalCode = "11000",
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.CommonEntities.Allergen", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("007b5585-d9d2-435e-a924-6cb640473b86"),
                            Name = "Kikiriki",
                            Type = "Orašasti plodovi"
                        },
                        new
                        {
                            Id = new Guid("732a7a9f-3b7d-4005-bdb0-c9dd6ef1e841"),
                            Name = "Jagode",
                            Type = "Voće"
                        },
                        new
                        {
                            Id = new Guid("3f165102-408b-469a-93c9-bc51997bdf51"),
                            Name = "Banane",
                            Type = "Voće"
                        },
                        new
                        {
                            Id = new Guid("8fd92abd-e434-4e2c-8b8c-641e361d5000"),
                            Name = "Kivi",
                            Type = "Voće"
                        },
                        new
                        {
                            Id = new Guid("3667b188-6bc6-4f52-a62f-739cd459c043"),
                            Name = "Breskve",
                            Type = "Voće"
                        },
                        new
                        {
                            Id = new Guid("d1c5f186-a74f-4d5e-81c2-7551a6ab471e"),
                            Name = "Paradajz",
                            Type = "Povrće"
                        },
                        new
                        {
                            Id = new Guid("8324fd9b-ea26-418e-8169-a3b854ca7c5c"),
                            Name = "Celer",
                            Type = "Povrće"
                        },
                        new
                        {
                            Id = new Guid("ca5cdbbb-352d-482a-8ebe-452485f8a596"),
                            Name = "Gluten",
                            Type = "Žitarice"
                        },
                        new
                        {
                            Id = new Guid("18293a4e-a2d5-4d18-846d-9ab875042db8"),
                            Name = "Pšenica",
                            Type = "Žitarice"
                        },
                        new
                        {
                            Id = new Guid("3912334f-48da-49b7-8c10-aa4025d4d6ea"),
                            Name = "Školjke",
                            Type = "Morski plodovi"
                        });
                });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.CommonEntities.BaseWorkSched", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("cd9e5671-155a-4463-908c-0525c04a5237"),
                            RestaurantId = new Guid("48442761-5f00-4a49-b686-b644b2f7b015"),
                            Saturday = true,
                            Sunday = true,
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.DishEntities.Dish", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a940510b-6569-4794-b9e6-a51ec09f038c"),
                            Description = "Pica sa šunkom i sirom.",
                            MenuId = new Guid("4045a4e5-9598-4359-ad3b-8ba2a93621d6"),
                            Name = "Capricciosa",
                            Price = 750.0,
                            Type = "Pizza"
                        });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.FeedbackEntities.FeedbackResponse", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Comment = "Jednostavno!",
                            CreatedAt = new DateTime(2025, 11, 3, 9, 55, 49, 429, DateTimeKind.Utc).AddTicks(4477),
                        ...
                        new
                        {
                            ...
                            Comment = "",
                            CreatedAt = new DateTime(2025, 11, 3, 9, 55, 49, 429, DateTimeKind.Utc).AddTicks(4483),
                        ...
                        new
                        {
                            ...
                            Comment = "",
                            CreatedAt = new DateTime(2025, 11, 3, 9, 55, 49, 429, DateTimeKind.Utc).AddTicks(4488),
                        ...
                        new
                        {
                            ...
                            Comment = "",
                            CreatedAt = new DateTime(2025, 11, 3, 9, 55, 49, 429, DateTimeKind.Utc).AddTicks(4492),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 3, 9, 55, 49, 429, DateTimeKind.Utc).AddTicks(4494),
                            QuestionId = new Guid("11111111-1111-1111-1111-111111111111"),
                            Rating = 2,
                        ...
                        new
                        {
                            ...
                            Comment = "Odlican!",
                            CreatedAt = new DateTime(2025, 11, 3, 9, 55, 49, 429, DateTimeKind.Utc).AddTicks(4499),
                            QuestionId = new Guid("22222222-2222-2222-2222-222222222222"),
                            Rating = 5,
                            UserId = new Guid("22222222-2222-2222-2222-222222222222")
                        },
                        new
                        {
                            ...
                            Comment = "Isporuka je bila na vreme.",
                            CreatedAt = new DateTime(2025, 11, 3, 9, 55, 49, 429, DateTimeKind.Utc).AddTicks(4502),
                            QuestionId = new Guid("33333333-3333-3333-3333-333333333333"),
                            Rating = 4,
                            UserId = new Guid("22222222-2222-2222-2222-222222222222")
                        },
                        new
                        {
                            ...
                            Comment = "",
                            CreatedAt = new DateTime(2025, 11, 3, 9, 55, 49, 429, DateTimeKind.Utc).AddTicks(4505),
                            QuestionId = new Guid("44444444-4444-4444-4444-444444444444"),
                            Rating = 2,
                            UserId = new Guid("22222222-2222-2222-2222-222222222222")
                        });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.RestaurantEntities.Menu", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4045a4e5-9598-4359-ad3b-8ba2a93621d6"),
                            Name = "Pizza Menu",
                            RestaurantId = new Guid("48442761-5f00-4a49-b686-b644b2f7b015")
                        });
                });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.RestaurantEntities.Restaurant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("48442761-5f00-4a49-b686-b644b2f7b015"),
                            AddressId = new Guid("3c0796ab-118e-4e54-bb4b-09828a580b30"),
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.UserEntities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b4284a17-9c0d-48ca-a62c-02677ed433c5",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEGCblrJnxuKFb3rnpJ87A4Jwn9RyfO8uA/FaUP8l8e/zp0LqKOrN3UcjuKqDTmfG8g==",
                            ...
                            SecurityStamp = "3131121f-4ea6-4b3f-be36-75f56ff11bdd",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "12489c37-1f21-43b4-b69d-cfba328dfcaa",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEC4efVypG/9GjqSOQg5ZuTnRPwJDVCY7vVld2a+W9WTkdw2YALYO6/Cn8jJN9S2B9Q==",
                            PhoneNumberConfirmed = false,
                            ProfilePictureBase64 = "data:image/png;base64,",
                            SecurityStamp = "9d37288b-4e56-49c1-93e8-d3afb87956db",
                            TwoFactorEnabled = false,
                            UserName = "admin2"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "7d4cea91-99ab-4fd8-902f-d7f63d7698d8",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEJTuGBSUs9MvZuWCDR7sOUvKUffPWheuzhUILqZuMT7FLOMHoYr7NDZ7weBBplnPig==",
                            PhoneNumberConfirmed = false,
                            ProfilePictureBase64 = "data:image/png;base64,",
                            SecurityStamp = "98f19692-7184-4b79-8ac6-94dc66cf162d",
                            TwoFactorEnabled = false,
                            UserName = "admin3"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "57af3324-3186-4220-b5f1-50834cde9166",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEPqLlWzY68ybAh4Bq0o/RwBkboHH5bXY+Oa5PXvZINKbeoE3VYP70BIiszwrpr67Xg==",
                            PhoneNumberConfirmed = false,
                            ProfilePictureBase64 = "data:image/png;base64,",
                            SecurityStamp = "3981178b-9ed0-4668-bf56-1760e84183a6",
                            TwoFactorEnabled = false,
                            UserName = "owner1"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "dc32f958-7331-418d-bdab-510ae6dc430f",
                            DateOfBirth = new DateTime(2025, 11, 3, 9, 55, 49, 387, DateTimeKind.Utc).AddTicks(4023),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEHsqT+28HBCN7sz/HiV6owO6axb74UO/RuyMGXtlRdjOuhFA52h0E4Pru/55cOm2GA==",
                            PhoneNumberConfirmed = false,
                            ProfilePictureBase64 = "data:image/png;base64,",
                            SecurityStamp = "e9a30193-c54f-4fca-80c5-e6d773b05e78",
                            TwoFactorEnabled = false,
                            UserName = "customer1"
                        });
                });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.UserEntities.Voucher", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("bdf63eb3-aff8-4751-b982-6edc3ae2316c"),
                            Code = "7OA44",
                            CustomerId = new Guid("44444444-4444-4444-4444-444444444444"),
                            DateIssued = new DateTime(2025, 11, 3, 9, 55, 49, 429, DateTimeKind.Utc).AddTicks(4942),
                            DiscountAmount = 1200.0,
                            ExpirationDate = new DateTime(2025, 11, 4, 9, 55, 49, 429, DateTimeKind.Utc).AddTicks(4933),
                            Name = "TestVaučer",
                            Status = "Active"
                        });
                });
