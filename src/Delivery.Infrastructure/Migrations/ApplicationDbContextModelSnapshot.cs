            ...
            modelBuilder.Entity("Delivery.Domain.Entities.CommonEntities.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("085f7aee-41d2-4048-831a-133449ab67ed"),
                            City = "Beograd",
                            PostalCode = "11000",
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.CommonEntities.Allergen", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2032194e-dc72-4db3-8df1-0eda04354d2a"),
                            Name = "Kikiriki",
                            Type = "Orašasti plodovi"
                        },
                        new
                        {
                            Id = new Guid("610b2967-4162-44c5-8706-9b810f725a30"),
                            Name = "Jagode",
                            Type = "Voće"
                        },
                        new
                        {
                            Id = new Guid("95100c03-fd21-4fba-807d-c8c36f9ce4dd"),
                            Name = "Banane",
                            Type = "Voće"
                        },
                        new
                        {
                            Id = new Guid("69f51db2-87bb-41af-8b00-3f89825e3df9"),
                            Name = "Kivi",
                            Type = "Voće"
                        },
                        new
                        {
                            Id = new Guid("ec044952-1a9f-4665-91f1-36c1435d6d2d"),
                            Name = "Breskve",
                            Type = "Voće"
                        },
                        new
                        {
                            Id = new Guid("16108980-1d6e-4626-9bc0-d3f0429e66fd"),
                            Name = "Paradajz",
                            Type = "Povrće"
                        },
                        new
                        {
                            Id = new Guid("33d36373-e910-45ce-b198-06820a67cacc"),
                            Name = "Celer",
                            Type = "Povrće"
                        },
                        new
                        {
                            Id = new Guid("41948bb3-e2d3-457d-a13f-fdc2e18aa7aa"),
                            Name = "Gluten",
                            Type = "Žitarice"
                        },
                        new
                        {
                            Id = new Guid("974ebdf1-adea-4af3-ab50-6fe5b3a95c2f"),
                            Name = "Pšenica",
                            Type = "Žitarice"
                        },
                        new
                        {
                            Id = new Guid("ecccb839-c9a0-4db2-9477-c2baa509a310"),
                            Name = "Školjke",
                            Type = "Morski plodovi"
                        });
                });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.CommonEntities.BaseWorkSched", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("183bd920-5c22-4863-8aa4-4fce34c27c9a"),
                            RestaurantId = new Guid("06be8937-d874-4bc4-a7e5-9018011f91e4"),
                            Saturday = true,
                            Sunday = true,
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.DishEntities.Dish", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0390e84b-2942-4c81-a1a4-5030c2bd734c"),
                            Description = "Pica sa šunkom i sirom.",
                            MenuId = new Guid("8b14b4af-7a12-4b51-9380-b355edf57e70"),
                            Name = "Capricciosa",
                            Price = 750.0,
                            Type = "Pizza"
                        });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.FeedbackEntities.FeedbackResponse", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Comment = "Jednostavno!",
                            CreatedAt = new DateTime(2025, 11, 1, 22, 0, 48, 875, DateTimeKind.Utc).AddTicks(1556),
                        ...
                        new
                        {
                            ...
                            Comment = "",
                            CreatedAt = new DateTime(2025, 11, 1, 22, 0, 48, 875, DateTimeKind.Utc).AddTicks(1565),
                        ...
                        new
                        {
                            ...
                            Comment = "",
                            CreatedAt = new DateTime(2025, 11, 1, 22, 0, 48, 875, DateTimeKind.Utc).AddTicks(1569),
                        ...
                        new
                        {
                            ...
                            Comment = "",
                            CreatedAt = new DateTime(2025, 11, 1, 22, 0, 48, 875, DateTimeKind.Utc).AddTicks(1572),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 1, 22, 0, 48, 875, DateTimeKind.Utc).AddTicks(1576),
                            QuestionId = new Guid("11111111-1111-1111-1111-111111111111"),
                            Rating = 2,
                        ...
                        new
                        {
                            ...
                            Comment = "Odlican!",
                            CreatedAt = new DateTime(2025, 11, 1, 22, 0, 48, 875, DateTimeKind.Utc).AddTicks(1579),
                            QuestionId = new Guid("22222222-2222-2222-2222-222222222222"),
                            Rating = 5,
                            UserId = new Guid("22222222-2222-2222-2222-222222222222")
                        },
                        new
                        {
                            ...
                            Comment = "Isporuka je bila na vreme.",
                            CreatedAt = new DateTime(2025, 11, 1, 22, 0, 48, 875, DateTimeKind.Utc).AddTicks(1597),
                            QuestionId = new Guid("33333333-3333-3333-3333-333333333333"),
                            Rating = 4,
                            UserId = new Guid("22222222-2222-2222-2222-222222222222")
                        },
                        new
                        {
                            ...
                            Comment = "",
                            CreatedAt = new DateTime(2025, 11, 1, 22, 0, 48, 875, DateTimeKind.Utc).AddTicks(1605),
                            QuestionId = new Guid("44444444-4444-4444-4444-444444444444"),
                            Rating = 2,
                            UserId = new Guid("22222222-2222-2222-2222-222222222222")
                        });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.RestaurantEntities.Menu", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8b14b4af-7a12-4b51-9380-b355edf57e70"),
                            Name = "Pizza Menu",
                            RestaurantId = new Guid("06be8937-d874-4bc4-a7e5-9018011f91e4")
                        });
                });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.RestaurantEntities.Restaurant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("06be8937-d874-4bc4-a7e5-9018011f91e4"),
                            AddressId = new Guid("085f7aee-41d2-4048-831a-133449ab67ed"),
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.UserEntities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "0043ca84-47c2-4e78-8c08-f306a093ce24",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEPEUqRqIEYnt+yzwtrms63CAwg0RKrHjRKgXpBHefVilGrFfDQ2ZmWsvYZ2yu3A+Uw==",
                            ...
                            SecurityStamp = "31d8abd5-9eb8-48c7-8779-a379ad519aec",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "0d7acbec-2143-45ed-9e59-91f0fa4c8c17",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEEtYzwppFy90XMa3EjE7HX5xie0weTpVUKbZqGbWdg0peRdIMwAh+vNf+K5wl5SDfQ==",
                            PhoneNumberConfirmed = false,
                            ProfilePictureBase64 = "data:image/png;base64,",
                            SecurityStamp = "10d39594-3c61-4cff-a9f3-1cc1523de519",
                            TwoFactorEnabled = false,
                            UserName = "admin2"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "d36702d6-a531-4b1d-a45d-1d7e529631cd",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEJrDTwWJPgiI+nPNsD9mnqrfqzs9cnBCYTsVzIEhDze+9iY9Tt7tHocNN+XMHzr/yA==",
                            PhoneNumberConfirmed = false,
                            ProfilePictureBase64 = "data:image/png;base64,",
                            SecurityStamp = "efb49b41-aa1c-4dc8-bc75-1797b3af67d0",
                            TwoFactorEnabled = false,
                            UserName = "admin3"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a1ab4206-38cf-46b0-8e3c-fc910463bf71",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEATCqPmTBBJcoiP1ueclUziJVheJivpa1icbgRI97RwLWj9ZiHblTH4Ew3B5b1Sk2g==",
                            PhoneNumberConfirmed = false,
                            ProfilePictureBase64 = "data:image/png;base64,",
                            SecurityStamp = "4e6c0fcc-0ed5-4530-90f6-5f0689523821",
                            TwoFactorEnabled = false,
                            UserName = "owner1"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b5e88f4d-e4c1-4cc3-862d-6a1ec8abfebd",
                            DateOfBirth = new DateTime(2025, 11, 1, 22, 0, 48, 805, DateTimeKind.Utc).AddTicks(8005),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEBoQ6mRnTEoP3EN8WMXYtz0dzOXW6vNn5ZVRbb+JtIPupsZwJku510VgT3Rxne2EWw==",
                            PhoneNumberConfirmed = false,
                            ProfilePictureBase64 = "data:image/png;base64,",
                            SecurityStamp = "04e1892c-abf0-4950-b4e1-39650e1ac8c4",
                            TwoFactorEnabled = false,
                            UserName = "customer1"
                        });
                });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.UserEntities.Voucher", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f23c8375-5570-4335-8c27-25d6d06c98ca"),
                            Code = "BTI1I",
                            CustomerId = new Guid("44444444-4444-4444-4444-444444444444"),
                            DateIssued = new DateTime(2025, 11, 1, 22, 0, 48, 875, DateTimeKind.Utc).AddTicks(2325),
                            DiscountAmount = 1200.0,
                            ExpirationDate = new DateTime(2025, 11, 2, 22, 0, 48, 875, DateTimeKind.Utc).AddTicks(2316),
                            Name = "TestVaučer",
                            Status = "Active"
                        });
                });
