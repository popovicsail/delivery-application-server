            ...
            modelBuilder.Entity("Delivery.Domain.Entities.CommonEntities.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("80b3a9a1-721e-42ac-8065-538fdf3d692c"),
                            City = "Beograd",
                            PostalCode = "11000",
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.CommonEntities.Allergen", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f8552d25-6598-4c41-93b4-4b74825a5fd2"),
                            Name = "Kikiriki",
                            Type = "Orašasti plodovi"
                        },
                        new
                        {
                            Id = new Guid("4413a6e3-da9f-4c2c-ba24-77bdef72534e"),
                            Name = "Jagode",
                            Type = "Voće"
                        },
                        new
                        {
                            Id = new Guid("55aab7c5-6352-45e3-b09a-6edae567e5e8"),
                            Name = "Banane",
                            Type = "Voće"
                        },
                        new
                        {
                            Id = new Guid("cfbfe90f-092a-4e1b-ab0b-5003a705e3f5"),
                            Name = "Kivi",
                            Type = "Voće"
                        },
                        new
                        {
                            Id = new Guid("2c8f0fa6-2afd-43ea-86a5-ae70c6e18f0b"),
                            Name = "Breskve",
                            Type = "Voće"
                        },
                        new
                        {
                            Id = new Guid("d5db668a-d7e4-4f6c-bb18-267d1520e01f"),
                            Name = "Paradajz",
                            Type = "Povrće"
                        },
                        new
                        {
                            Id = new Guid("ec04ff0e-bf69-4ecd-a181-07c981023303"),
                            Name = "Celer",
                            Type = "Povrće"
                        },
                        new
                        {
                            Id = new Guid("2a875f2e-683f-491c-a44e-91b0ad00dcbb"),
                            Name = "Gluten",
                            Type = "Žitarice"
                        },
                        new
                        {
                            Id = new Guid("f6807609-1f67-4a39-bdc6-28945ef8878b"),
                            Name = "Pšenica",
                            Type = "Žitarice"
                        },
                        new
                        {
                            Id = new Guid("caadf25d-1b2a-4ce6-a462-5f387ff80785"),
                            Name = "Školjke",
                            Type = "Morski plodovi"
                        });
                });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.CommonEntities.BaseWorkSched", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b1c12ab7-61f5-410d-92dd-fb0e113adcdf"),
                            RestaurantId = new Guid("2b30dc39-d911-4bc7-bb46-83b4f53297e4"),
                            Saturday = true,
                            Sunday = true,
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.DishEntities.Dish", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d0a2f333-4542-4e03-ada0-c8f46703a2bd"),
                            Description = "Pica sa šunkom i sirom.",
                            MenuId = new Guid("494e9227-7823-40c4-bb90-ee563830d752"),
                            Name = "Capricciosa",
                            Price = 750.0,
                            Type = "Pizza"
                        });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.FeedbackEntities.FeedbackResponse", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Comment = "Jednostavno!",
                            CreatedAt = new DateTime(2025, 10, 30, 17, 24, 16, 434, DateTimeKind.Utc).AddTicks(9884),
                        ...
                        new
                        {
                            ...
                            Comment = "",
                            CreatedAt = new DateTime(2025, 10, 30, 17, 24, 16, 434, DateTimeKind.Utc).AddTicks(9887),
                        ...
                        new
                        {
                            ...
                            Comment = "",
                            CreatedAt = new DateTime(2025, 10, 30, 17, 24, 16, 434, DateTimeKind.Utc).AddTicks(9890),
                        ...
                        new
                        {
                            ...
                            Comment = "",
                            CreatedAt = new DateTime(2025, 10, 30, 17, 24, 16, 434, DateTimeKind.Utc).AddTicks(9893),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 30, 17, 24, 16, 434, DateTimeKind.Utc).AddTicks(9898),
                            QuestionId = new Guid("11111111-1111-1111-1111-111111111111"),
                            Rating = 2,
                        ...
                        new
                        {
                            ...
                            Comment = "Odlican!",
                            CreatedAt = new DateTime(2025, 10, 30, 17, 24, 16, 434, DateTimeKind.Utc).AddTicks(9901),
                            QuestionId = new Guid("22222222-2222-2222-2222-222222222222"),
                            Rating = 5,
                            UserId = new Guid("22222222-2222-2222-2222-222222222222")
                        },
                        new
                        {
                            ...
                            Comment = "Isporuka je bila na vreme.",
                            CreatedAt = new DateTime(2025, 10, 30, 17, 24, 16, 434, DateTimeKind.Utc).AddTicks(9946),
                            QuestionId = new Guid("33333333-3333-3333-3333-333333333333"),
                            Rating = 4,
                            UserId = new Guid("22222222-2222-2222-2222-222222222222")
                        },
                        new
                        {
                            ...
                            Comment = "",
                            CreatedAt = new DateTime(2025, 10, 30, 17, 24, 16, 434, DateTimeKind.Utc).AddTicks(9949),
                            QuestionId = new Guid("44444444-4444-4444-4444-444444444444"),
                            Rating = 2,
                            UserId = new Guid("22222222-2222-2222-2222-222222222222")
                        });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.RestaurantEntities.Menu", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("494e9227-7823-40c4-bb90-ee563830d752"),
                            Name = "Pizza Menu",
                            RestaurantId = new Guid("2b30dc39-d911-4bc7-bb46-83b4f53297e4")
                        });
                });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.RestaurantEntities.Restaurant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2b30dc39-d911-4bc7-bb46-83b4f53297e4"),
                            AddressId = new Guid("80b3a9a1-721e-42ac-8065-538fdf3d692c"),
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.UserEntities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "1c305696-e7ac-4918-a279-4b2802a05e84",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEPeEE3xFaHmTBq8hZBzKZ46dYgw/AVyJTkMk5hV9ZRPGuG6u5cGrpnF+7kzxUYqSpA==",
                            ...
                            SecurityStamp = "d871f235-943d-4024-832a-7229fde0ef4f",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "f85ce41a-8f9f-4bdb-821d-b586dabbe7a1",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAELbwk5WAMnR36UFS2FPGtQl0s4xLgP7xhpyZFbj0yburqSjyxBB/kWs8YTUit6lt6w==",
                            PhoneNumberConfirmed = false,
                            ProfilePictureBase64 = "data:image/png;base64,",
                            SecurityStamp = "ee21d1a0-a804-4516-9a7f-34c6ae529a40",
                            TwoFactorEnabled = false,
                            UserName = "admin2"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "1d779ea7-c0e2-4478-8b59-4141314fcc9c",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEOey7UatUPrVRoXzxcl6MiIa1uwbsA2mOcw2BeHBlpYY8x8+tUsHja24klPFLH/OvQ==",
                            PhoneNumberConfirmed = false,
                            ProfilePictureBase64 = "data:image/png;base64,",
                            SecurityStamp = "ba3fafe7-5ab1-47f4-9d2b-f0d33446cd35",
                            TwoFactorEnabled = false,
                            UserName = "admin3"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b27dca89-827a-47b6-97e0-895c9ff0fb10",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEPXvHMF1xJl5lQn5z05WZmj2pQrzgBiLdnFO2cPvB527y6uE/rQ6CplbgPOd4NvjnQ==",
                            PhoneNumberConfirmed = false,
                            ProfilePictureBase64 = "data:image/png;base64,",
                            SecurityStamp = "8f4f0d0d-4eb8-4853-86d8-4573798e4273",
                            TwoFactorEnabled = false,
                            UserName = "owner1"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "fc9b4d07-bf79-4353-9735-2625ec128dc2",
                            DateOfBirth = new DateTime(2025, 10, 30, 17, 24, 16, 393, DateTimeKind.Utc).AddTicks(4457),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEJt2eyCtuLBJtmucIRWhdpOtgETV0RuOhIgLlWd3Hde47Ia8OoGF/vjHRvOYrDKJHw==",
                            PhoneNumberConfirmed = false,
                            ProfilePictureBase64 = "data:image/png;base64,",
                            SecurityStamp = "607cf01b-2a27-4a04-8b4e-e972ba8e7c79",
                            TwoFactorEnabled = false,
                            UserName = "customer1"
                        });
                });
            ...
            modelBuilder.Entity("Delivery.Domain.Entities.UserEntities.Voucher", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("49fe43d2-cdd6-46c1-a20d-e093a80b561f"),
                            Code = "3XU9K",
                            CustomerId = new Guid("44444444-4444-4444-4444-444444444444"),
                            DateIssued = new DateTime(2025, 10, 30, 17, 24, 16, 435, DateTimeKind.Utc).AddTicks(3322),
                            DiscountAmount = 1200.0,
                            ExpirationDate = new DateTime(2025, 10, 31, 17, 24, 16, 435, DateTimeKind.Utc).AddTicks(3313),
                            Name = "TestVaučer",
                            Status = "Active"
                        });
                });
