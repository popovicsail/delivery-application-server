    ...
    public partial class InitalCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("08de8cbc-ed67-4579-93e3-73288b498b29"), "Paradajz", "Povrće" },
                    { new Guid("093c94e6-8d3b-4c97-8c2d-84c4e894ed71"), "Banane", "Voće" },
                    { new Guid("18959964-54b0-4549-9990-81c51ba4b67b"), "Kivi", "Voće" },
                    { new Guid("8d821cfa-a9fa-4a52-9418-7a27c36f117d"), "Školjke", "Morski plodovi" },
                    { new Guid("a6997456-2b70-4087-bb00-7b8097400328"), "Breskve", "Voće" },
                    { new Guid("b9228288-1ca4-479b-bd7a-73fb01af948b"), "Gluten", "Žitarice" },
                    { new Guid("c4a07794-54d1-4c86-88f0-7c6a2e175313"), "Celer", "Povrće" },
                    { new Guid("cf1858d0-2291-4180-b2ee-98d1ab3a9eeb"), "Pšenica", "Žitarice" },
                    { new Guid("fbb86b0e-3826-4086-b552-840300c752c8"), "Kikiriki", "Orašasti plodovi" },
                    { new Guid("fd524039-1c5a-4293-94ed-17dad80fdb93"), "Jagode", "Voće" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("07df7e6b-ec02-47f2-942b-cbad07e1c142"), new Guid("06b60e91-be6d-4d3e-bd1a-c0f3488ace7b"), "Autentična italijanska kuhinja.", "", "Pizzeria Roma", new Guid("33333333-3333-3333-3333-333333333333"), "222" });

            migrationBuilder.InsertData(
                table: "vouchers",
                columns: new[] { "id", "active", "code", "customer_id", "date_issued", "discount_amount", "expiration_date", "name" },
                values: new object[] { new Guid("dcfd7414-bf3f-4777-a1ec-2c910c27d731"), true, "ZKRST", new Guid("44444444-4444-4444-4444-444444444444"), new DateTime(2025, 10, 23, 20, 22, 46, 653, DateTimeKind.Utc).AddTicks(7659), 1200.0, new DateTime(2025, 10, 24, 20, 22, 46, 653, DateTimeKind.Utc).AddTicks(7645), "TestVaučer" });

            migrationBuilder.InsertData(
                table: "base_work_scheds",
                columns: new[] { "id", "restaurant_id", "saturday", "sunday", "weekend_end", "weekend_start", "work_day_end", "work_day_start" },
                values: new object[] { new Guid("c63a4129-439d-4cb3-a445-01c520f08dff"), new Guid("07df7e6b-ec02-47f2-942b-cbad07e1c142"), true, true, new TimeSpan(0, 21, 30, 0, 0), new TimeSpan(0, 12, 0, 0, 0), new TimeSpan(0, 22, 0, 0, 0), new TimeSpan(0, 10, 0, 0, 0) });

            migrationBuilder.InsertData(
                table: "menus",
                columns: new[] { "id", "name", "restaurant_id" },
                values: new object[] { new Guid("55555555-5555-5555-5555-555555555555"), "Pizza Menu", new Guid("07df7e6b-ec02-47f2-942b-cbad07e1c142") });

            migrationBuilder.InsertData(
                table: "dishes",
                columns: new[] { "id", "description", "menu_id", "name", "picture_url", "price", "type" },
                values: new object[] { new Guid("f0291f65-1211-4fef-83cb-36c04cb52c74"), "Pica sa šunkom i sirom.", new Guid("55555555-5555-5555-5555-555555555555"), "Capricciosa", null, 750.0, "Pizza" });
