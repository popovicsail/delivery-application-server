    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0ac4702b-c876-4a94-a8e9-e06183654414"), "Gluten", "Žitarice" },
                    { new Guid("6cd969e6-08b8-46e1-b8f7-cee8663065de"), "Pšenica", "Žitarice" },
                    { new Guid("a0daa3de-f886-4637-b1d9-01245df3c9e6"), "Paradajz", "Povrće" },
                    { new Guid("a25a732c-4d32-49a6-b129-a65fdcd0ee9e"), "Kikiriki", "Orašasti plodovi" },
                    { new Guid("b2a7b032-1b32-40e6-9131-1bc7fd388ee3"), "Banane", "Voće" },
                    { new Guid("b3d39d77-5d4d-44a5-98b4-c119d559b3e8"), "Breskve", "Voće" },
                    { new Guid("b597f5df-8717-4483-9e06-3ac26b9457fd"), "Školjke", "Morski plodovi" },
                    { new Guid("d03c16b8-2f58-4c65-9bae-688226ed4d27"), "Celer", "Povrće" },
                    { new Guid("e5537a86-da11-44ac-80d1-272594f32500"), "Kivi", "Voće" },
                    { new Guid("ff576bc4-4a2d-48b9-a530-8f1a98099021"), "Jagode", "Voće" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("2eef1487-4939-49eb-8a16-a8a6ea48a168"), new Guid("5a3ef8ff-bb4c-4448-ad0c-d90e67092676"), "Autentična italijanska kuhinja.", "", "Pizzeria Roma", new Guid("33333333-3333-3333-3333-333333333333"), "222" });

            migrationBuilder.InsertData(
                table: "vouchers",
                columns: new[] { "id", "active", "code", "customer_id", "date_issued", "discount_amount", "expiration_date", "name" },
                values: new object[] { new Guid("4376426d-fe3b-4c33-9e1b-78ceaa46ff19"), true, "71HL8", new Guid("44444444-4444-4444-4444-444444444444"), new DateTime(2025, 10, 19, 20, 57, 30, 766, DateTimeKind.Utc).AddTicks(872), 1200.0, new DateTime(2025, 10, 20, 20, 57, 30, 766, DateTimeKind.Utc).AddTicks(864), "TestVaučer" });

            migrationBuilder.InsertData(
                table: "base_work_scheds",
                columns: new[] { "id", "restaurant_id", "saturday", "sunday", "weekend_end", "weekend_start", "work_day_end", "work_day_start" },
                values: new object[] { new Guid("78765209-dae6-4d10-acb7-c914013e5cda"), new Guid("2eef1487-4939-49eb-8a16-a8a6ea48a168"), true, true, new TimeSpan(0, 21, 30, 0, 0), new TimeSpan(0, 12, 0, 0, 0), new TimeSpan(0, 22, 0, 0, 0), new TimeSpan(0, 10, 0, 0, 0) });

            migrationBuilder.InsertData(
                table: "menus",
                columns: new[] { "id", "name", "restaurant_id" },
                values: new object[] { new Guid("55555555-5555-5555-5555-555555555555"), "Pizza Menu", new Guid("2eef1487-4939-49eb-8a16-a8a6ea48a168") });

            migrationBuilder.InsertData(
                table: "dishes",
                columns: new[] { "id", "description", "menu_id", "name", "picture_url", "price", "type" },
                values: new object[] { new Guid("55685539-ef48-44ae-8242-ad2a022a2286"), "Pica sa šunkom i sirom.", new Guid("55555555-5555-5555-5555-555555555555"), "Capricciosa", null, 750.0, "Pizza" });
