        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    was_given_birthday_voucher = table.Column<bool>(type: "boolean", nullable: false),
                    user_id = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "customers",
                columns: new[] { "id", "loyalty_points", "user_id", "was_given_birthday_voucher" },
                values: new object[] { new Guid("44444444-4444-4444-4444-444444444444"), 5, new Guid("22222222-2222-2222-2222-222222222222"), false });
