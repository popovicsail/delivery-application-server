    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("33fc708d-a055-4f20-8a16-f1d88f9dceae"), "Pšenica", "Žitarice" },
                    { new Guid("3cffeb4b-f5ba-4443-b74c-18f856d448a0"), "Banane", "Voće" },
                    { new Guid("6eae25a9-e035-47b7-9d4c-d31e7b1e60db"), "Breskve", "Voće" },
                    { new Guid("73e7180c-16f1-4153-91f2-892703eb1732"), "Gluten", "Žitarice" },
                    { new Guid("857b31da-a18c-49ee-a542-49daa2e5a025"), "Paradajz", "Povrće" },
                    { new Guid("8dcd8553-085f-46f1-99c4-cda64d033196"), "Školjke", "Morski plodovi" },
                    { new Guid("9b3268be-578f-4d5d-8118-0bb705c4d86f"), "Kikiriki", "Orašasti plodovi" },
                    { new Guid("aa316cf0-53aa-4def-a98f-f6f09bda6a56"), "Kivi", "Voće" },
                    { new Guid("baa0cc0d-535d-4b08-ad75-9ce231707a81"), "Jagode", "Voće" },
                    { new Guid("fe205774-85b9-4021-b35c-c7d62aaad5fd"), "Celer", "Povrće" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("27eb9e17-d069-43ce-99eb-0e238094b611"), new Guid("abe4ec32-4db4-4925-ab33-335baa858ef1"), "Autentična italijanska kuhinja.", "", "Pizzeria Roma", new Guid("33333333-3333-3333-3333-333333333333"), "222" });

            migrationBuilder.InsertData(
                table: "vouchers",
                columns: new[] { "id", "code", "customer_id", "date_issued", "discount_amount", "expiration_date", "name", "status" },
                values: new object[] { new Guid("3564623f-d094-4d46-a763-9dbf47249f1b"), "LQR6K", new Guid("44444444-4444-4444-4444-444444444444"), new DateTime(2025, 10, 23, 23, 16, 34, 296, DateTimeKind.Utc).AddTicks(114), 1200.0, new DateTime(2025, 10, 24, 23, 16, 34, 296, DateTimeKind.Utc).AddTicks(100), "TestVaučer", "Active" });

            migrationBuilder.InsertData(
                table: "base_work_scheds",
                columns: new[] { "id", "restaurant_id", "saturday", "sunday", "weekend_end", "weekend_start", "work_day_end", "work_day_start" },
                values: new object[] { new Guid("4eaf1e3b-8c51-4b4a-969a-a5b19aea8b16"), new Guid("27eb9e17-d069-43ce-99eb-0e238094b611"), true, true, new TimeSpan(0, 21, 30, 0, 0), new TimeSpan(0, 12, 0, 0, 0), new TimeSpan(0, 22, 0, 0, 0), new TimeSpan(0, 10, 0, 0, 0) });

            migrationBuilder.InsertData(
                table: "menus",
                columns: new[] { "id", "name", "restaurant_id" },
                values: new object[] { new Guid("3878bb8a-bb4c-463f-b19f-38e7149d7a7f"), "Pizza Menu", new Guid("27eb9e17-d069-43ce-99eb-0e238094b611") });

            migrationBuilder.InsertData(
                table: "dishes",
                columns: new[] { "id", "description", "menu_id", "name", "picture", "price", "type" },
                values: new object[] { new Guid("127e1cac-e329-43d5-8418-4e344cacadc8"), "Pica sa šunkom i sirom.", new Guid("3878bb8a-bb4c-463f-b19f-38e7149d7a7f"), "Capricciosa", null, 750.0, "Pizza" });
