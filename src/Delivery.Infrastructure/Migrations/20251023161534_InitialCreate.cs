    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("2f5b2dea-134f-4d7b-ac5a-a47dace97380"), "Gluten", "Žitarice" },
                    { new Guid("413f5867-abe9-4141-994b-a6a426ba9a3f"), "Celer", "Povrće" },
                    { new Guid("439f6313-8013-4c6c-a9b0-906383f4f4c5"), "Jagode", "Voće" },
                    { new Guid("469d1151-d0db-4dec-a1b5-0efa6185fd9e"), "Pšenica", "Žitarice" },
                    { new Guid("5ded7a38-bb3f-4e1d-aa49-caad63ce46a8"), "Banane", "Voće" },
                    { new Guid("5ff6cd37-f437-461d-9985-fb116dad5b90"), "Paradajz", "Povrće" },
                    { new Guid("66efcd35-ef14-4d82-ae96-c3035da4ecf0"), "Kikiriki", "Orašasti plodovi" },
                    { new Guid("6f31274e-6dad-49a3-9eab-ab93082c284c"), "Kivi", "Voće" },
                    { new Guid("a90c63cd-2183-491a-bb36-623efe285ead"), "Školjke", "Morski plodovi" },
                    { new Guid("b9254691-f34b-4f79-be94-afa4204bf20c"), "Breskve", "Voće" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("76d3eb09-9c1b-47fc-b2c1-31c99ed00f99"), new Guid("0c6eb250-472f-4bdb-bce4-395bac0b3bb8"), "Autentična italijanska kuhinja.", "", "Pizzeria Roma", new Guid("33333333-3333-3333-3333-333333333333"), "222" });

            migrationBuilder.InsertData(
                table: "vouchers",
                columns: new[] { "id", "active", "code", "customer_id", "date_issued", "discount_amount", "expiration_date", "name" },
                values: new object[] { new Guid("d99e50ad-a4e1-460b-9dba-42bbeea4cdc5"), true, "V1Q5K", new Guid("44444444-4444-4444-4444-444444444444"), new DateTime(2025, 10, 23, 16, 15, 34, 125, DateTimeKind.Utc).AddTicks(317), 1200.0, new DateTime(2025, 10, 24, 16, 15, 34, 125, DateTimeKind.Utc).AddTicks(309), "TestVaučer" });

            migrationBuilder.InsertData(
                table: "base_work_scheds",
                columns: new[] { "id", "restaurant_id", "saturday", "sunday", "weekend_end", "weekend_start", "work_day_end", "work_day_start" },
                values: new object[] { new Guid("af291be7-60c9-4f31-82c4-acc3ab042e69"), new Guid("76d3eb09-9c1b-47fc-b2c1-31c99ed00f99"), true, true, new TimeSpan(0, 21, 30, 0, 0), new TimeSpan(0, 12, 0, 0, 0), new TimeSpan(0, 22, 0, 0, 0), new TimeSpan(0, 10, 0, 0, 0) });

            migrationBuilder.InsertData(
                table: "menus",
                columns: new[] { "id", "name", "restaurant_id" },
                values: new object[] { new Guid("55555555-5555-5555-5555-555555555555"), "Pizza Menu", new Guid("76d3eb09-9c1b-47fc-b2c1-31c99ed00f99") });

            migrationBuilder.InsertData(
                table: "dishes",
                columns: new[] { "id", "description", "menu_id", "name", "picture", "price", "type" },
                values: new object[] { new Guid("ee957f86-a608-48a3-98a1-572aa46eb8e4"), "Pica sa šunkom i sirom.", new Guid("55555555-5555-5555-5555-555555555555"), "Capricciosa", null, 750.0, "Pizza" });
